  ...
  return (
    <>
      ...
      <div className="btns ipad:flex justify-center gap-4 pb-8 hidden">
        <NavLink
          to="/All"
          className="hover:bg-[#AD343E] bg-[#DBDFD0] hover:px-12 top-10 hover:py-2 py-2 px-12  mt-8  rounded-3xl hover:duration-500 duration-500 hover:shadow-2xl font-medium font-DMSans text-[20px]"
        >
          All
        </NavLink>
        ...
        <NavLink
          to="/Desserts"
          className="hover:bg-[#AD343E] bg-[#AD343E] hover:px-6 top-10 hover:py-2 px-6  py-2 mt-8  rounded-3xl hover:duration-500 duration-500 hover:shadow-xl font-medium font-DMSans text-[18px]"
        >
          Desserts
        </NavLink>
